...
class AA_3D(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, kernel_size, padding=0):
        ...
        self.conv1 = nn.Conv3d(in_channels=in_channel, out_channels=out_channel, kernel_size=(3, kernel_size, kernel_size), padding=(0, padding, padding))
        self.conv2 = nn.Conv2d(in_channels=out_channel * 2, out_channels=out_channel, kernel_size=1)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        if stride != 1 or in_planes != self.expansion * planes:
            self.shortcut = nn.Sequential(
                AA_3D(in_channel=in_planes, out_channel=self.expansion * planes, kernel_size=1),
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.bn1 = nn.BatchNorm2d(planes)
        ####
        self.conv2 = AA_3D(in_channel=planes, out_channel=planes, kernel_size=3, padding=1)
        ####
        self.bn2 = nn.BatchNorm2d(planes)
